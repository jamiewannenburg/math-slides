...
( function( document, window ) {
    ...
    var impress = window.impress = function( rootId ) {
        ...
        var init = function() {
            ...
            // Get and init steps
            steps = $$( ".slide", root ); // changed this to slide
...
( function( document, window ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        document.addEventListener( "keyup", function( event ) {
            ...
            if ( event.keyCode === 9 || event.keyCode === 8 || event.keyCode === 66 ||
               ( event.keyCode >= 32 && event.keyCode <= 34 ) ||
               ( event.keyCode >= 37 && event.keyCode <= 40 ) ) {
        ...
        document.addEventListener( "click", function( event ) {
            ...
            while ( !( target.classList.contains( "slide" ) && // changed this
                      !target.classList.contains( "active" ) &&
                      !target.classList.contains( "unselectable" )
                      ) &&
                      ( target !== document.documentElement ) ) {
                target = target.parentNode;
            }
        ...
        window.addEventListener( "resize", throttle( function() {
            ...
            api.goto( document.querySelector( ".slide.active" ), 500 ); //chagned this
        }, 250 ), false );
